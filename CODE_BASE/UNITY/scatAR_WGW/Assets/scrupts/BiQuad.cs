...
using UnityEngine;
	...
	public static BiQuadFilter highPassAirFilter(float sampleRate) {
		var filter = new BiQuadFilter ();
		//this is a lowpass filter, despite incorrect naming
		//15k hz
		/*
	...
	*/
		...
		//12k hz
		filter.a0 = 0.3474131111495974;
		filter.a1 = 0.6948262222991948;
		filter.a2 = 0.3474131111495974;
		filter.a3 = 0.21025828138266484;
		filter.a4 = 0.17939416321572463;
