...
public abstract class BaseAndroidDevice {
  protected AndroidJavaObject androidActivity;

  public  bool SupportsNativeDistortionCorrection(List<string> diagnostics) {
    bool support = SupportsNativeDistortionCorrection(diagnostics);
